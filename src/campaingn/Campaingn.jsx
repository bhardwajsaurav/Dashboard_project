...
const Campaingn = () => {
    ...
    return (
        <>
            ...
            <section className="camp p-4 mt-4 position-relative">
                <div className="container">
                                                    ...
                                                    return (
                                                        ...
                                                        <>
                                                            ...
                                                            <tr key={"ad" + index}>
                                                                ...
                                                                <label htmlFor="">
                                                                            <input type="radio" name="ad" onClick={(e) => { inputHandlerModal(e, adserverdata.data[0].advertiser_id, elem.campaign_id, "ad") }}/>
                   ...
                   {
                    close &&  <Modal   setClose={setClose} lineItems={lineItems} />
                   }
